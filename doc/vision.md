...
A `contacc` node could provide a different model:
...
`contacc` is an attempt to build the substrate for something better, starting from the simplest case and leaving the architecture open enough to grow.
